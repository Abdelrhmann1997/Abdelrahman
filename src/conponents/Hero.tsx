    ...
    items-center justify-center py-28 md:px-32 mt-20">
      <div className="flex flex-col items-center justify-center gap-10 text-white">
        ...
        className="flex max-w-150 flex-col items-center justify-center gap-3 text-center">
            ...
            <p className="md:text-base text-pretty text-sm text-gray-400">Frontend Developer with a strong foundation in HTML, CSS, and JavaScript, specializing in building modern, scalable, and responsive web applications using React.js, Next.js, and TypeScript. Experienced in creating reusable components, managing state, integrating REST APIs, and debugging issues to deliver clean and reliable user interfaces, while leveraging AI tools like Antigravity and Stitch AI to improve development speed and workflow.</p>
        </motion.div>
      </div>
    </div>
  )
